...
public class Player {
	...
	public void selectChar(int id) {
		...
		System.out.println("Character: " + this.getName() + "\tWeapon: " + this.getWeaponName() + "\tArmor: "
				+ this.getArmorName() + "\tDamage: " + this.getDamage() + "\tHealth: " + this.getHealth() + "\tWealth: "
				+ this.getWealth() + "\t\tInventory: food-" + (inventory.getFood()) + " water-" + (inventory.getWater())
