...
public class ToolStore extends NormalLoc {
	...
	public boolean onLocation() {
		...
		System.out.println("Welcome Mr. " + this.getPlayer().getUsername()
				+ "... I'm your weapon provider. What would you like to purchase?");
		System.out.println();
	...
	public void selectionApi() {
		...
		case 0:
			...
			break;
		default:
			System.out.println("We don't have this kind of an option, Mr. " + this.getPlayer().getUsername()
					+ ". Please, Try Again!");
			System.out.println();
			selectionApi();
		}
	...
	public void buyWeapon() {
		...
		case 0:
			break;
		default:
			System.out.println("We don't have this kind of a weapon, Mr. " + this.getPlayer().getUsername()
					+ ". Please, Try Again!");
			System.out.println();
			buyWeapon();
		}
	...
	public void buyArmor() {
		...
		case 0:
			break;
		default:
			System.out.println("We don't have this kind of a armor, Mr. " + this.getPlayer().getUsername()
					+ ". Please, Try Again!");
			System.out.println();
			buyArmor();
		}
